                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            {{Form::text('business-name',$client->business->name, array('class'=>'form-control'))}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{Form::text('business-mobile',( ($client->business->mobile) ? $client->business->mobile->description : '') , array('class'=>'form-control'))}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{Form::text('business-telephone',( ($client->business->telephone) ? $client->business->telephone->description: '' ), array('class'=>'form-control'))}}
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            <label>Address</label>
                                            {{Form::textarea('business-address',( ($client->business->address) ? $client->business->address->description: '' ), array('class'=>'form-control resize-vertical'))}}
                                        ...
                                        <div class="form-group">
                                            <label>Email</label>
                                            {{Form::email('business-email',$client->email, array('class'=>'form-control'))}}
                                            @if($errors->has('business-email'))
                                                <span class="text-danger">{{$errors->first('business-email')}}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
