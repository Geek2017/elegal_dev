    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-4">
            <div class="title-action">
                <button type="submit" id="create-billing" class="btn btn-primary">Create Billing</button>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="ibox float-e-margins setter">
                    <div class="ibox-title">
                        <h5>Client's with Service Report's</h5>
                    </div>
            ...
            <div class="col-sm-9">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" id="billing-box"></div>
                </div>
                ...
                $.get('{!! route('fetch-service-report') !!}',{
                    ...
                    if(data[0].length > 0){
                        ...
                        if(data[2].length > 0){
                            for(var bal = 0; bal < data[2].length; bal++){
                                switch(data[2][bal].paid){
                                    case 1:
                                        balance.push('' +
                                            '<tr>' +
                                            '<td></td>' +
                                            '<td colspan="2">Bill #'+ data[2][bal].bill_number +'</td>' +
                                            '<td>'+ numeral(data[2][bal].balance).format('0,0.00') +'</td>' +
                                            '</tr>' +
                                            '');
                                    ...
                                    default:
                                        balance.push('' +
                                            ...
                                            '<td></td>' +
                                            '<td colspan="2">Bill #'+ data[2][bal].bill_number +'</td>' +
                                            '<td>'+ numeral(data[2][bal].total).format('0,0.00') +'</td>' +
                                            '</tr>' +
                                            '');
                                ...
                                if(data[2][bal].operational_fund !== null){
                                    trustFundBalance.push('' +
                                        '<tr>' +
                                        '<td></td>' +
                                        '<td colspan="2">Bill #'+ data[2][bal].bill_number +'</td>' +
                                        '<td>'+ numeral(data[2][bal].operational_fund.amount).format('0,0.00') +'</td>' +
                                        '</tr>' +
                                        '');
                        ...
                        if(percentageTax > 0){
                            ...
                            grandTotal += pfTax;
                            pfTax = '<tr>' +
                                '<td>Total Percentage Tax on PF</td>' +
                                '<td>'+ numeral(pfTax).format('0,0.00') +'</td>' +
                                '</tr>';
                        }
                        ...
                        billBox.prepend('' +
                            ...
                            '</div>' +
                            '<div class="panel-body">' +
                            '<h5>I. Professional Fees</h5>' +
                            '<div class="row">' +
                            '<div class="col-sm-12">' +
                            '<div class="title">' +
                            '<h5>Previous Balance <span class="pull-right">'+ numeral(subBalance).format('0,0.00') +'</span></h5>' +
                            '</div>' +
                            '<div class="table-responsive">' +
                            '<table>' +
                            '<tbody>' +
                            '<tr>' +
                            '<td colspan="3"><strong>Balance from previous bill</strong></td>' +
                            '<td></td>' +
                            '</tr>' +
                            '' + balance.join('') +
                            '</tbody>' +
                            ...
                            '<td></td>' +
                            '<td>'+ numeral(subPaymentReceived).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td></td>' +
                            '<td colspan="2"><strong>Unpaid Balance</strong></td>' +
                            '<td><strong>'+ numeral(subBalance).format('0,0.00') +'</strong></td>' +
                            '</tr>' +
                            '</tbody>' +
                            '</table>' +
                            '</div>' +
                            ...
                            '<div class="col-sm-12">' +
                            '<div class="title">' +
                            '<h5>Current Charges <span class="pull-right">'+ numeral(current).format('0,0.00') +'</span></h5>' +
                            '</div>' +
                            '<div class="table-responsive">' +
                            '<table>' +
                            '<tbody>' +
                            '<tr>' +
                            '<td colspan="3">PF (Special Retainers)</td>' +
                            '<td>'+ numeral(specialRetainer).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td colspan="3">PF (Fixed General Retainer)</td>' +
                            '<td>'+ numeral(fixedGeneralRetainer).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td colspan="3">PF (Excess General Retainers)</td>' +
                            '<td>'+ numeral(excessGeneralRetainer).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td colspan="3">Paralegal Charges</td>' +
                            '<td>'+ numeral(paralegalCharge).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '</tbody>' +
                            '<tbody>' +
                            '<tr>' +
                            '<td><strong>Less: </strong></td>' +
                            '<td colspan="2">Adjustment</td>' +
                            '<td>'+ numeral(adjustmentCharges).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td></td>' +
                            '<td colspan="2"><strong>Total Current Charges</strong></td>' +
                            '<td><strong>'+ numeral(current).format('0,0.00') +'</strong></td>' +
                            '</tr>' +
                            '</tbody>' +
                            '</table>' +
                            '</div>' +
                            ...
                            '<div class="col-sm-12">' +
                            '<div class="title">' +
                            '<h5>Total Amount Due <span class="pull-right">'+ numeral(subTotal).format('0,0.00') +'</span></h5>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '<div class="panel-body">' +
                            '<h5>II. Trust Fund Fees</h5>' +
                            '<div class="row">' +
                            '<div class="col-sm-12">' +
                            '<div class="title">' +
                            '<h5>'+ titles.join('; ') +' <span class="pull-right">'+ numeral(subBalance).format('0,0.00') +'</span></h5>' +
                            '</div>' +
                            '<div class="table-responsive">' +
                            '<table>' +
                            '<tbody>' +
                            ...
                            '<tr class="tr-line">' +
                            '<td><strong>Less: </strong></td>' +
                            '<td colspan="2">Reimbursement Received</td>' +
                            '<td>'+ numeral(subReimbursementReceived).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td></td>' +
                            '<td colspan="2"><strong>Unpaid Balance</strong></td>' +
                            '<td><strong>'+ numeral(trustFundSubBalance).format('0,0.00') +'</strong></td>' +
                            '</tr>' +
                            '</tbody>' +
                            '</table>' +
                            '</div>' +
                            ...
                            '<td>'+ numeral(chargeableExpense).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td>Less:</td>' +
                            '<td>Deposit</td>' +
                            '<td></td>' +
                            '<td>'+ numeral(trustFund).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td></td>' +
                            '<td colspan="2"><strong>Total Amount For Reimbursement</strong></td>' +
                            '<td><strong>'+ numeral(reimbursement).format('0,0.00') +'</strong></td>' +
                            '</tr>' +
                            '</tbody>' +
                            '</table>' +
                            '</div>' +
                        ...
                        billBox.prepend('' +
                            '<div class="row">' +
                            '<div class="col-sm-6">' +
                            '<h3>'+ data[1].profile.full_name +'</h3>' +
                            '<p>'+ data[1].business.address.description +'</p>' +
                            '</div>' +
                            '<div class="col-sm-6 billing-header">' +
                            '<table>' +
                            '<tbody>' +
                            '<tr>' +
                            '<th>Invoice No. :</th>' +
                            ...
                            '<tr>' +
                            '<td>'+ data[1].count +'</td>' +
                            '<td>'+ data[1].business.telephone.description +'</td>' +
                            '<td>0.00</td>' +
                            '</tr>' +
                            '</tbody>' +
                            '</table>' +
                            ...
                            '<thead>' +
                            '<tr>' +
                            '<th class="text-center" colspan="2">From '+ moment().startOf('month').format('MMM D, YYYY') +' to '+ moment().endOf('month').format('MMM D, YYYY') +'</th>' +
                            '</tr>' +
                            '</thead>' +
                            '<tbody>' +
                            '<tr>' +
                            ...
                            '</tr>' +
                            '<tr>' + pfTax +
                            '<td>Total Expenses for reimbursement</td>' +
                            '<td>'+ numeral(reimbursement).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td>Grand Total</td>' +
                            '<td>&#8369 '+ numeral(grandTotal).format('0,0.00') +'</td>' +
                            '</tr>' +
                            '</tbody>' +
                            '</table>' +
                            '<div class="clearfix"></div>' +
