    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('change', '#client-select', function(){
                ...
                console.log('client: '+ setter.find('select[name="client"]').val());
                        ...
                        '<div class="row">' +
                            '<div class="col-sm-4 col-sm-push-8">' +
                                '<div class="professional-services"><h2>Professional Services</h2>' +
                                    ...
                                    '<tr><td>Client ID</td><td>[ '+ data[3].count +' ]</td></tr>' +
                        ...
                        '<div class="col-sm-4">' +
                            '<div class="bill-to">' +
                                '<div class="panel panel-default summary">' +
                                    '<div class="panel-heading text-center"><strong>to:</strong></div>' +
                                    '<div class="p-xs">' +
...
//                console.log('client_id : '+ setter.find('select[name="client"]').val());
...
//                        window.open('http://'+window.location.host+'/billings/'+ data.id +'/pdf');
            ...
            function getMonth(){
                ...
                $.get('{!! route('get-month') !!}',{
                    ...
                    console.log(data);
//                    console.log('$generalRetainer : '+ data[0]);
//                    console.log('$transactionFeeDetails : '+ data[1]);
//                    console.log('$serviceReports : '+ data[2]);
//                    return false;
                        ...
                        for(var a = 0; a < data.length; a++){
                            setter.find('tbody').append('' +
                                '<tr>' +
                                    ...
                                    '</td>' +
                                    '<td>' +
                                        '<strong>'+ (data[a].cases.title ? data[a].cases.title : 'No Case Name') +'</strong>' +
                ...
                $.get('{!! route('get-special-billing') !!}',{
                    ...
                    billSummary.append('' +
                        '<div class="row">' +
                            '<div class="col-sm-12">' +
                                '<div class="title"><h5>Current Charges <span class="pull-right">'+ numeral(currentCharges).format('0,0.00') +'</span></h5></div>' +
                                '<div class="sub-title"><h4>'+ (data[0].cases.title ? data[0].cases.title : 'No Case Name') +' '+ caseNumber +'</h4> <small>[ <i>Case Information</i> ]</small></div>' +
                                '<div class="table-responsive">' +
                                    '<table class="table-summary">' +
                                        '<tbody>' +
                                            '' + info +
