                            ...
                            <div class="col-lg-6">
                                <div class="col-lg-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input name="ars_date" type="date" class="form-control" value="{{ old('ars_date') }}" required>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="table-bordered">
                                        ...
                                        <tbody id="ars-desc-body">
                                            <tr>
                                                <td>1</td>
                                                <td><textarea rows="2" name='descriptions[]' type='text' class='form-control' required></textarea></td>
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-3">
                                    <div class="input-group time-picker" id="time-picker-1" data-autoclose="true">
                                        ...
                                        <input name="time_start" type="text" class="form-control time-mask" id="time-start" value="{{ old('time_start') }}" required>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group time-picker" id="time-picker-2" data-autoclose="true">
                                        ...
                                        <input name="time_finnish" type="text" class="form-control time-mask" id="time-finish" value="{{ old('time_finnish') }}" data-mask="99:99" required>
                                        <span class="input-group-addon">
                                            <span class="fa fa-clock-o"></span>
                                        </span>
                                    </div>                                    
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group m-b"><span class="input-group-addon bg-muted">Duration</span>
                                        <input name="duration" type="text" class="form-control" id="duration" value="{{ old('duration') }}" required>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <textarea rows="2" name='billing_instruction' class='form-control' required></textarea>
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="input-group m-b"><span class="input-group-addon bg-muted">Billing Entry</span>
                                        <textarea rows="2" name='billing_entry' class='form-control' required></textarea>
                                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $caseSelect.select2({
              ajax: {
                url: function () {
                    return '{!! route("transactions.client-cases") !!}?id='+$clientSelect.val();
                },
                dataType: 'json'
                // Additional AJAX parameters go here; see the end of this chapter for the full code of this example
              },
