                                ...
                                <div class="row">
                                    {{--<div class="col-sm-6">--}}
                                        {{--<div class="form-group">--}}
                                            ...
                                            {{--{!! Form::text('contract_amount', $data->contract->contract_amount, array('class' => 'form-control numonly')) !!}--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                    <div class="col-sm-12">
                                        <div class="form-group">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.other-conditions', function () {
                updateContract();
//                delay(function(){
//                    updateContract();
//                }, 1500 );
                ...
                switch (type){
                    case 'fee':
                        $.post('{!! route('store-fee') !!}',{
                            ...
                            free_page: parseInt(modal.find('input[name="free_page"]').val()||0),
                            excess_rate: parseFloat(modal.find('input[name="excess_rate"]').val()||0),
                            cap_value: parseFloat(modal.find('input[name="cap_value"]').val()||0),
                            minutes: parseInt(modal.find('input[name="minutes"]').val()||0),
                            installment: parseFloat(modal.find('input[name="installment"]').val()||0),
                            percentage: parseInt(modal.find('input[name="percentage"]').val()||0),
                            amount: parseFloat(modal.find('input[name="amount"]').val()||0),
...
//                                modal.find('select[name="co_counsel"]').chosen().trigger("chosen:updated");
                    ...
                    if(data.counsel_list.length > 0){
                        ...
                        for(var a = 0; a < data.counsel_list.length; a++){
                            switch(data.counsel_list[a].lead){
                                case 1:
                                    counselSelect.push('<option value="'+ data.counsel_list[a].counsel_id +'">[ LC ]: '+ data.counsel_list[a].info.profile.full_name +'</option>');
                                    break;
                                default:
                                        ...
                                        switch (data[a].fees[c].charge_type){
                                            ...
                                            case 'percentage':
                                                ...
                                                desc.push('<div class="data-info">' +
                                                    ...
                                                    '</div>');
                                                desc.push('<div class="data-info">' +
                                                    '<h4>'+ data[a].fees[c].percentage +'</h4>' +
            ...
            var amountType = function () {
                var data = '' +
                    '<div class="form-group">' +
                    '<label>Amount</label>' +
                    '<input type="text" name="amount" class="form-control numonly">' +
                    '</div>' +
                    '';
                return data;
            };
            ...
            var documentType = function () {
                var data = '' +
                    ...
                    '<input type="text" name="free_page" class="form-control numonly required">' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label>Amount Charge First</label>' +
                    '<input type="text" name="amount" class="form-control numonly required">' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label>Rate in Excess</label>' +
                    '<input type="text" name="excess_rate" class="form-control numonly">' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label>With Cap / Cieling</label>' +
                    '<input type="text" name="cap_value" class="form-control numonly">' +
                    '</div>' +
                    '';
                return data;
            };
            ...
            var timeType = function () {
                var data = '' +
                    ...
                    '<input type="text" name="minutes" class="form-control numonly">' +
                    '</div>' +
                    '';
                return data;
            };
            ...
            var installmentType = function () {
                var data = '' +
                    ...
                    '<input type="text" name="installment" class="form-control numonly">' +
                    '</div>' +
                    '';
                return data;
            };
