            ...
            <div class="col-lg-6 col-lg-offset-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h2>Cash Receipt Payments Report</h2>
                    </div>
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <select class="form-control select2" id="clients" name="client_id">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <button class="btn btn-success btn-md" id="show-all-report">Show All</button>
                                <button class="btn btn-primary btn-md pull-right" id="show-report">Show Client Payment</button>
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Cash Receipt Payments Report</h4>
          </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function(){
            ...
            $( "#show-all-report" ).on('click', function( /*event */) {
                var $url = "{{ route('reports.show-cash-receipt') }}";
